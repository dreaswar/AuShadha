...
def social_history_json(request):
    try:
        ...
        if action == 'add':
            return social_history_add(request, id)
...
@login_required
def social_history_add(request, id):
        ...
        if request.method == "GET" and request.is_ajax():
                ...
                if social_history_obj:
                    ...
                    variable = RequestContext(request,
                                              {"user": user,
                                               ...
                                               'button_label': "Add",
                                               "action": patient_detail_obj.get_social_history_add_url(),
                                               "addUrl": patient_detail_obj.get_social_history_add_url(),
                                               'canDel': False,
                                               'editUrl': None,
                                               'delUrl': None
                                               })
            ...
            try:
                ...
                if social_history_form.is_valid():
                    ...
                    form_errors = ''
                    for error in social_history_form.errors:
...
@login_required
def social_history_edit(request, id):
...
@login_required
def social_history_del(request, id):
    user = request.user
