...
urlpatterns = patterns('',
	...
	url(r'fda_drug_db/json/all_drugs/$', fda_drug_db_json_all_drugs, name = 'fda_drug_db_json_all_drugs'),
	url(r'fda_drug_db/json_for_a_drug/(?P<drug_id>\d+)/$', fda_drug_db_json_for_a_drug, name = 'fda_drug_db_json_for_a_drug'),
