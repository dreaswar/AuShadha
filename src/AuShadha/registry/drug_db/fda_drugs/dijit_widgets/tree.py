...
from registry.drug_db.fda_drugs.models import FDADrugs
...
class DrugDBTree( object ):
    ...
    def __init__(self, *args, **kwargs):
      ...
      self.yaml_path =  kwargs.get('yaml_path','registry/drug_db/fda_drugs/dijit_widgets/tree.yaml')
      ...
      try:
        ...
        with open('registry/drug_db/fda_drugs/dijit_widgets/rendered_tree.yaml','r' ) as in_file:
...
#      tree = DrugDBTree(**d)()
      ...
      with open('registry/drug_db/fda_drugs/dijit_widgets/rendered_tree.yaml', 'rb') as in_file:
          y = yaml.load(in_file)
