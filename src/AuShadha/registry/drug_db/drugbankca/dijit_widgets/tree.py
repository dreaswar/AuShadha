...
class DrugBankCaDrugsTree(object):
    ...
    def __init__(self, *args, **kwargs):
        try:
            ...
            raise Exception(
                "DrugBankCa Tree Object should be initialized with a HttpRequest object at a named parameter")

        self.node_name = kwargs.get('node_name', 'drugbankca_drugs')
        self.yaml_path = kwargs.get(
            'yaml_path', 'registry/drug_db/drugbankca/dijit_widgets/tree.yaml')
