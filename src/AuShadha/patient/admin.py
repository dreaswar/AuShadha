...
class PatientDetailAdmin(admin.ModelAdmin):
    list_display =['patient_hospital_id','first_name','middle_name','last_name']
...
class PatientContactAdmin(admin.ModelAdmin):
    list_display =['patient_detail','address','city','state','country','pincode']
...
class PatientDemographicsAndSocialDataAdmin(admin.ModelAdmin):
  pass
...
admin.site.register(PatientDemographicsAndSocialData, PatientDemographicsAndSocialDataAdmin)
