    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                ...
                patient_family_history_obj = PatientFamilyHistory(
                    patient_detail=patient_detail_obj)
                patient_family_history_add_form = PatientFamilyHistoryForm(
                    instance=patient_family_history_obj)
...
#        raise Http404("BadRequest")
            ...
            try:
                ...
                patient_family_history_obj = PatientFamilyHistory(
                    patient_detail=patient_detail_obj)
                patient_family_history_add_form = PatientFamilyHistoryForm(
                    request.POST, instance=patient_family_history_obj)
...
def patient_family_history_edit(request, id):
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_family_history_obj = PatientFamilyHistory.objects.get(
                    pk=id)
                patient_family_history_edit_form = PatientFamilyHistoryForm(
                    instance=patient_family_history_obj)
                variable = RequestContext(request,
                                          {"user": user,
