...
def return_patient_json(patient, success=True):
    ...
    if patient:
        ...
        data_to_append['patientTreeUrl']   =  APP_ROOT_URL + \
            "pat/tree/?patient_id=" + patient_id

        data_to_append['patientsummary']     = APP_ROOT_URL + \
            "pat/summary/?patient_id=" + patient_id
        data_to_append['sidebarcontacttab']  = APP_ROOT_URL + \
            "pat/sidebar_contact_tab/?patient_id=" + patient_id
        ...
        data_to_append['contactjson']  = APP_ROOT_URL + \
            "pat/contact/json/?patient_id=" + patient_id

        data_to_append['phoneadd'] = patient.get_patient_phone_add_url()
        data_to_append['phonelist'] = patient.get_patient_phone_list_url()
        data_to_append['phonejson']  = APP_ROOT_URL + \
            "pat/phone/json/?patient_id=" + patient_id

        data_to_append['guardianadd'] = patient.get_patient_guardian_add_url()
        data_to_append[
            'guardianlist'] = patient.get_patient_guardian_list_url()
        data_to_append['guardianjson']  = APP_ROOT_URL + \
            "pat/guardian/json/?patient_id=" + patient_id

        data_to_append[
            'emailadd'] = patient.get_patient_email_and_fax_add_url()
        data_to_append[
            'emaillist'] = patient.get_patient_email_and_fax_list_url()
        data_to_append['emailjson']     = APP_ROOT_URL + \
            "pat/email/json/?patient_id=" + patient_id

        data_to_append[
            'admissionadd'] = patient.get_patient_admission_add_url()
        data_to_append[
            'admissionlist'] = patient.get_patient_admission_list_url()
        data_to_append[
            'admissionjson'] = patient.get_patient_admission_list_url()
...
#        data_to_append['visitjson']    = APP_ROOT_URL+"pat/visit/json/?patient_id="+ patient_id
        data_to_append['visittree']        = APP_ROOT_URL + \
            "visit/render_visit_tree/?patient_id=" + patient_id
        data_to_append['visitsummary']     = APP_ROOT_URL + \
            "visit/summary/" + patient_id + "/"
        data_to_append['patientvisitspdf']  = APP_ROOT_URL + \
            "visit/render_patient_visits_pdf/" + patient_id + "/"

        data_to_append[
            'demographicsadd'] = patient.get_patient_demographics_data_add_url()
        data_to_append[
            'demographicslist'] = patient.get_patient_demographics_data_list_url()

        data_to_append[
            'familyhistorylist'] = patient.get_patient_family_history_list_url()
        data_to_append[
            'familyhistoryadd'] = patient.get_patient_family_history_add_url()
        data_to_append['familyhistoryjson']  = APP_ROOT_URL + \
            "pat/family_history/json/?patient_id=" + patient_id

        data_to_append[
            'medicalhistorylist'] = patient.get_patient_medical_history_list_url()
        data_to_append[
            'medicalhistoryadd'] = patient.get_patient_medical_history_add_url()
        data_to_append['medicalhistoryjson']  = APP_ROOT_URL + \
            "pat/medical_history/json/?patient_id=" + patient_id

        data_to_append[
            'surgicalhistorylist'] = patient.get_patient_surgical_history_list_url()
        data_to_append[
            'surgicalhistoryadd'] = patient.get_patient_surgical_history_add_url()
        data_to_append['surgicalhistoryjson']  = APP_ROOT_URL + \
            "pat/surgical_history/json/?patient_id=" + patient_id

        data_to_append[
            'immunisationadd'] = patient.get_patient_immunisation_add_url()
        data_to_append[
            'immunisationlist'] = patient.get_patient_immunisation_list_url()
        data_to_append['immunisationjson']  = APP_ROOT_URL + \
            "pat/immunisation/json/?patient_id=" + patient_id

        data_to_append[
            'medicationlistadd'] = patient.get_patient_medication_list_add_url()
        data_to_append[
            'medicationlistlist'] = patient.get_patient_medication_list_list_url()
        data_to_append['medicationlistjson']  = APP_ROOT_URL + \
            "pat/medication_list/json/?patient_id=" + patient_id

        data_to_append[
            'allergiesadd'] = patient.get_patient_allergies_add_url()
        data_to_append[
            'allergieslist'] = patient.get_patient_allergies_list_url()
        data_to_append['allergiesjson']  = APP_ROOT_URL + \
            "pat/allergies/json/?patient_id=" + patient_id

        data_to_append[
            'socialhistoryadd'] = patient.get_patient_social_history_add_url()
        data_to_append[
            'socialhistorylist'] = patient.get_patient_social_history_list_url()

        data_to_append[
            'obstetrichistorydetailadd'] = patient.get_patient_obstetric_history_detail_add_url()
        data_to_append[
            'obstetrichistorydetaillist'] = patient.get_patient_obstetric_history_detail_list_url()
...
def render_patient_tree(request, id=None):
    if request.method == "GET" and request.is_ajax():
        if id:
            ...
            immunisation_obj = PatientImmunisation.objects.filter(
                patient_detail=pat_obj)

            medication_list_obj = PatientMedicationList.objects.filter(
                patient_detail=pat_obj)
            allergies_obj = PatientAllergies.objects.filter(
                patient_detail=pat_obj)
...
def render_patient_summary(request, id=None):
    if request.method == "GET" and request.is_ajax():
        ...
        try:
            pat_obj = PatientDetail.objects.get(pk=patient_id)
            pat_contact_obj = PatientContact.objects.filter(
                patient_detail=pat_obj)
            pat_phone_obj = PatientPhone.objects.filter(
                patient_detail=pat_obj)
            pat_guardian_obj = PatientGuardian.objects.filter(
                patient_detail=pat_obj)

            pat_medical_history_obj = PatientMedicalHistory.objects.filter(
                patient_detail=pat_obj)
            pat_surgical_history_obj = PatientSurgicalHistory.objects.filter(
                patient_detail=pat_obj)
            pat_social_history_obj = PatientSocialHistory.objects.filter(
                patient_detail=pat_obj)
            pat_family_history_obj = PatientFamilyHistory.objects.filter(
                patient_detail=pat_obj)
            pat_demographics_obj = PatientDemographicsData.objects.filter(
                patient_detail=pat_obj)

            pat_allergy_obj = PatientAllergies.objects.filter(
                patient_detail=pat_obj)
            pat_medication_list_obj = PatientMedicationList.objects.filter(
                patient_detail=pat_obj)

            pat_immunisation_obj = PatientImmunisation.objects.filter(
                patient_detail=pat_obj)
            pat_obstetric_history_detail_obj = ObstetricHistoryDetail.objects.filter(
                patient_detail=pat_obj)

            pat_admission_obj = Admission.objects.filter(
                patient_detail=pat_obj)
            pat_visit_obj = VisitDetail.objects.filter(
                patient_detail=pat_obj)
...
def render_patient_list(request):
    ...
    def create_patient_list_json(all_patients):
        for patient in all_patients:
            ...
            addData[
                'emaillist'] = patient.get_patient_email_and_fax_list_url()
            addData['emailjson']     = APP_ROOT_URL + \
                "pat/email/json/?patient_id=" + patient_id
        ...
        #        addData['admissionjson']  = APP_ROOT_URL+"pat/admission_json/"+ patient_id
            ...
            addData['visitjson']         = APP_ROOT_URL + \
                "pat/visit/json/?patient_id=" + patient_id
            addData['visittree']         = APP_ROOT_URL + \
                "visit/render_visit_tree/?patient_id=" + patient_id
            addData['visitsummary']      = APP_ROOT_URL + \
                "visit/summary/" + patient_id + "/"
            ...
            addData[
                'familyhistorylist'] = patient.get_patient_family_history_add_url()
            addData[
                'familyhistoryadd'] = patient.get_patient_family_history_list_url()
            addData['familyhistoryjson']  = APP_ROOT_URL + \
                "pat/family_history/json/?patient_id=" + patient_id

            addData[
                'medicalhistorylist'] = patient.get_patient_medical_history_add_url()
            addData[
                'medicalhistoryadd'] = patient.get_patient_medical_history_list_url()
            addData['medicalhistoryjson']  = APP_ROOT_URL + \
                "pat/medical_history/json/?patient_id=" + patient_id

            addData[
                'surgicalhistorylist'] = patient.get_patient_surgical_history_add_url()
            addData[
                'surgicalhistoryadd'] = patient.get_patient_surgical_history_list_url()
            addData['surgicalhistoryjson']  = APP_ROOT_URL + \
                "pat/surgical_history/json/?patient_id=" + patient_id
            ...
            addData[
                'immunisationlist'] = patient.get_patient_immunisation_list_url()
            addData['immunisationjson']  = APP_ROOT_URL + \
                "pat/immunisation/json/?patient_id=" + patient_id
            ...
            addData[
                'medicationlistlist'] = patient.get_patient_medication_list_list_url()
            addData['medicationlistjson']  = APP_ROOT_URL + \
                "pat/medication_list/json/?patient_id=" + patient_id

            addData['allergiesadd'] = patient.get_patient_allergies_add_url()
            addData[
                'allergieslist'] = patient.get_patient_allergies_list_url()
            addData['allergiesjson']  = APP_ROOT_URL + \
                "pat/allergies/json/?patient_id=" + patient_id
...
def contact_json(request):
    ...
    patient_contact_obj = PatientContact.objects.filter(
...
def phone_json(request):
    try:
        ...
        raise Http404("ERROR:: Patient requested does not exist.")
    patient_phone_obj = PatientPhone.objects.filter(
        patient_detail=patient_detail_obj)
...
def guardian_json(request):
    try:
        ...
        raise Http404("ERROR:: Patient requested does not exist.")
    patient_guardian_obj = PatientGuardian.objects.filter(
        patient_detail=patient_detail_obj)
...
def demographics_json(request):
    try:
        ...
        patient_detail_obj = PatientDetail.objects.get(pk=id)
        patient_demographics_obj = PatientDemographicsData.objects.filter(
            patient_detail=patient_detail_obj)
...
def social_history_json(request):
    try:
        ...
        patient_detail_obj = PatientDetail.objects.get(pk=id)
        patient_social_history_obj = PatientSocialHistory.objects.filter(
            patient_detail=patient_detail_obj)
...
def allergies_json(request):
    try:
        ...
        patient_detail_obj = PatientDetail.objects.get(pk=id)
        patient_allergies_obj = PatientAllergies.objects.filter(
            patient_detail=patient_detail_obj)
#    json_list = []
...
def immunisation_json(request):
    try:
        ...
        patient_detail_obj = PatientDetail.objects.get(pk=id)
        patient_immunisation_obj = PatientImmunisation.objects.filter(
            patient_detail=patient_detail_obj)
#    json_list = []
...
def family_history_json(request):
    try:
        ...
        patient_detail_obj = PatientDetail.objects.get(pk=id)
        patient_family_history_obj = PatientFamilyHistory.objects.filter(
            patient_detail=patient_detail_obj)
#    json_list = []
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_detail_obj = PatientDetail.objects.get(pk=id)
                patient_allergies_obj = PatientAllergies(
                    patient_detail=patient_detail_obj)
                patient_allergies_add_form = PatientAllergiesForm(
                    instance=patient_allergies_obj)
                variable = RequestContext(request,
                                          {"user": user,
...
#        raise Http404("BadRequest")
            ...
            try:
                ...
                patient_allergies_obj = PatientAllergies(
                    patient_detail=patient_detail_obj)
                patient_allergies_add_form = PatientAllergiesForm(
                    request.POST, instance=patient_allergies_obj)
...
def patient_allergies_edit(request, id):
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_allergies_obj = PatientAllergies.objects.get(
                    pk=id)
                patient_allergies_edit_form = PatientAllergiesForm(
                    instance=patient_allergies_obj)
                variable = RequestContext(request,
                                          {"user": user,
    ...
    if request.user and user.is_superuser:
        if request.method == "GET":
            try:
                ...
                raise Http404(
                    "BadRequest: Patient allergies Data Does Not Exist")
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_detail_obj = PatientDetail.objects.get(pk=id)
                patient_contact_obj = PatientContact(
                    patient_detail=patient_detail_obj)
                patient_contact_add_form = PatientContactForm(
                    instance=patient_contact_obj)
                variable = RequestContext(request,
                                          {"user": user,
                                           "patient_detail_obj": patient_detail_obj,
            ...
            try:
                ...
                patient_contact_obj = PatientContact(
                    patient_detail=patient_detail_obj)
                patient_contact_add_form = PatientContactForm(
                    request.POST, instance=patient_contact_obj)
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                ...
                patient_contact_edit_form = PatientContactForm(
                    instance=patient_contact_obj)
            ...
            try:
                ...
                raise Http404(
                    "BadRequest: Requested Patient contact DoesNotExist")
        else:
            raise Http404("BadRequest: Unsupported Request Method")
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_detail_obj = PatientDetail.objects.get(pk=id)
                patient_email_and_fax_obj = PatientEmailAndFax(
                    patient_detail=patient_detail_obj)
                patient_email_and_fax_add_form = PatientEmailAndFaxForm(
                    instance=patient_email_and_fax_obj)
                variable = RequestContext(request,
                                          {"user": user,
                                           "patient_detail_obj": patient_detail_obj,
            ...
            try:
                ...
                patient_email_and_fax_obj = PatientEmailAndFax(
                    patient_detail=patient_detail_obj)
                patient_email_and_fax_add_form = PatientEmailAndFaxForm(
                    request.POST, instance=patient_email_and_fax_obj)
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                ...
                patient_email_and_fax_edit_form = PatientEmailAndFaxForm(
                    instance=patient_email_and_fax_obj)
                ...
                raise Http404(
                    "BadRequest: Patient email_and_fax Data Does Not Exist")
            return render_to_response('patient/email_and_fax/edit.html', variable)
        elif request.method == 'POST' and request.is_ajax():
            try:
                id = int(id)
                patient_email_and_fax_obj = PatientEmailAndFax.objects.get(
                    pk=id)
                patient_detail_obj = patient_email_and_fax_obj.patient_detail
                patient_email_and_fax_edit_form = PatientEmailAndFaxForm(
                    request.POST, instance=patient_email_and_fax_obj)
                ...
                raise Http404(
                    "BadRequest: Requested Patient email_and_fax DoesNotExist")
        else:
            raise Http404("BadRequest: Unsupported Request Method")
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_detail_obj = PatientDetail.objects.get(pk=id)
                patient_guardian_obj = PatientGuardian(
                    patient_detail=patient_detail_obj)
                patient_guardian_add_form = PatientGuardianForm(
                    instance=patient_guardian_obj)
                variable = RequestContext(request,
                                          {"user": user,
                                           "patient_detail_obj": patient_detail_obj,
            ...
            try:
                ...
                patient_guardian_obj = PatientGuardian(
                    patient_detail=patient_detail_obj)
                patient_guardian_add_form = PatientGuardianForm(
                    request.POST, instance=patient_guardian_obj)
...
def patient_guardian_edit(request, id):
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_guardian_obj = PatientGuardian.objects.get(
                    pk=id)
                patient_guardian_edit_form = PatientGuardianForm(
                    instance=patient_guardian_obj)
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_detail_obj = PatientDetail.objects.get(pk=id)
                patient_phone_obj = PatientPhone(
                    patient_detail=patient_detail_obj)
                patient_phone_add_form = PatientPhoneForm(
                    instance=patient_phone_obj)
                variable = RequestContext(request,
                                          {"user": user,
                                           "patient_detail_obj": patient_detail_obj,
            ...
            try:
                ...
                patient_phone_obj = PatientPhone(
                    patient_detail=patient_detail_obj)
                patient_phone_add_form = PatientPhoneForm(
                    request.POST, instance=patient_phone_obj)
    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                ...
                patient_phone_edit_form = PatientPhoneForm(
                    instance=patient_phone_obj)
            ...
            try:
                ...
                raise Http404(
                    "BadRequest: Requested Patient Phone DoesNotExist")
        else:
            raise Http404(
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                ...
                if demographics_obj:
                    ...
                    patient_demographics_data_form = PatientDemographicsDataForm(
                        instance=patient_demographics_data_obj)
                    variable = {'user': user,
                                'patient_detail_obj': patient_detail_obj,
                    ...
                    patient_demographics_data_obj = PatientDemographicsData(
                        patient_detail=patient_detail_obj)
                    patient_demographics_data_form = PatientDemographicsDataForm(
                        instance=patient_demographics_data_obj)
                    variable = RequestContext(request,
            ...
            try:
                ...
                patient_demographics_data_obj = PatientDemographicsData(
                    patient_detail=patient_detail_obj)
                patient_demographics_data_form = PatientDemographicsDataForm(
                    request.POST, instance=patient_demographics_data_obj)
...
def patient_demographics_edit(request, id):
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                patient_demographics_data_obj = PatientDemographicsData.objects.get(
                    pk=id)
                patient_demographics_data_form = PatientDemographicsDataForm(
                    instance=patient_demographics_data_obj)
...
def patient_demographics_del(request, id):
    ...
    if request.user and user.is_superuser:
        if request.method == "GET":
            try:
                id = int(id)
                patient_demographics_obj = PatientDemographicsData.objects.get(
                    pk=id)
