...
def generate_json_for_datagrid(
        obj,
        success=True,
            ...
            for element in obj:
                ...
                data = {
                    ...
                    'edit': getattr(
                        element,
                        'get_edit_url()',
                        element.get_edit_url()),
                    'del': getattr(
                        element,
                        'get_del_url()',
                        element.get_del_url()),
                    'patient_detail': getattr(
                        element,
                        'patient_detail.__unicode__()',
                        None)}
                            ...
                            if i.name == 'aushadhabasemodel_ptr':
                                ...
                                if element is not None:
                                    data[
                                        ...
                                        element,
                                        '__unicode__()',
                                        element.administrator if getattr(
                                            element,
                                            'administrator',
                                            None) else None)
                                else:
                                ...
                                if element is not None:
                                    data[
                                        ...
                                        element,
                                        '__unicode__()',
                                        element.vaccine_detail.__unicode__())
                                else:
                                    data[i.name] = 'None'
                            else:
                ...
                try:
                    if i.name == 'aushadhabasemodel_ptr':
                        ...
                        data[
                            ...
                            obj,
                            'vaccine_name',
                            obj.vaccine_detail.vaccine_name)
                    else:
