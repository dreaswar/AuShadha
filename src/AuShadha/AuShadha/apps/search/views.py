...
def aushadha_patient_search(request, patient_id=None):
    ...
    '''
    # FIXME Dojo sends REST queries with * suffix. This has to be split and
    # dealt with before json generation is done.
    ...
    if request.method == "GET" and request.is_ajax():
        if not patient_id:
            try:
                ...
                # print "You have queried Patients with Full Name containing:
                # ", name
            ...
            if pat_obj:
                for patient in pat_obj:
                    ...
                    data_to_append['paneUrl'] = reverse(
                        'render_patient_pane_with_id', kwargs={
...
########################## OLD CODE. NEEDS TO BE RELOOKED. THIS WAS THE EA
