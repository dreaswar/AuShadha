...
//   {% else %}
    ...
    grid.onRowClick = function(e) { 
                          ...
                          var phoneUrl = "{%url phone_json %}" + 
                                         "?patient_id=" 
                                         + patid;
                          var guardianUrl = "{%url guardian_json %}" + 
                                            "?patient_id=" 
                                            + patid;
                    										         ...
                    										         function(xhr, registry, Dialog){
                    										           var myDialog = dijit.byId("editPatientDialog");
																				           xhr.get({
																				                   ...
																				                   load: function(html){
																				                         myDialog.set('content', html);
																				                         myDialog.set('title', "Add Patient");
																				                         myDialog.show();
																				                   }
                                                   });
										                             });
                                                  ...
                                                  function(xhr, array){
                                                    ...
                                                    xhr.get({
                                                      ...
                                                      load: function(html){
                               										           var myDialog = dijit.byId("editPatientDialog");
																		                         myDialog.set('content', html);
																		                         myDialog.set('title', "Add Contact");
																		                         myDialog.show();
																				                   }
                                                   });
                                                 })
                                                  ...
                                                  function(xhr, array){
                                                    ...
                                                    xhr.get({
                                                      ...
                                                      load: function(html){
                               										           var myDialog = dijit.byId("editPatientDialog");
																		                         myDialog.set('content', html);
																		                         myDialog.set('title', "Add Guardian");
																		                         myDialog.show();
																				                   }
                                                   });
                                                 })
                                                  ...
                                                  function(xhr, array){
                                                    ...
                                                    xhr.get({
                                                      ...
                                                      load: function(html){
                               										           var myDialog = dijit.byId("editPatientDialog");
																		                         myDialog.set('content', html);
																		                         myDialog.set('title', "Add Admission");
																		                         myDialog.show();
																				                   }
                                                   });
                                                 })
