    ...
    function (dom,
        ...
        return {
            constructor: function (obj
                /* {widget:{label : String,title : String, parent: String}, 
