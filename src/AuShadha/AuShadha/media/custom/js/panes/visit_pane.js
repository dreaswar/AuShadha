    ...
    function (registry,
        ...
        var VISIT_PANE = {
            ...
            displayPatientName: function () {
                ...
                var topBarHTML = dom.byId('selected_patient_info')
                    .innerHTML;
                var topBarStyle = domAttr.get(dom.byId('selected_patient_info'),
                    'style');

                dom.byId('visitPaneTopbar')
            ...
            constructor: function () {
                ...
                console.log(
                    "Entering constructor function: Starting to create / select visit tab as necessary..."
                );
                ...
                if (!this.initialized) {
                    ...
                    /*
                            ...
                            */
                    request(CHOSEN_PATIENT.visitsummary)
                        .then(
                            function (html) {
                                //                                 registry.byId('visitPaneRSidebar').set('content',html);
                                registry.byId('visitSummaryTab')
                                    .set('content', html);
                            },
                            function (err) {
                                publishError(err);
            ...
            destroyPane: function () {
                ...
                if (registry.byId('centerTopTabPane')
                    .getIndexOfChild(registry.byId('visitHomeContentPane')) != -
                    1
                ) {
            ...
            onVisitChange: function () {
                ...
                registry.byId('visitSummaryTab')
                    .set('href', CHOSEN_PATIENT.visitsummary);
                new buildVisitTree();
            ...
            addPane: {
                ...
                dijits: function (nodeId) {
                    ...
                    var visitAddTab = new ContentPane({
                            id: this.nodeId,
                            closable: true
                        },
                        nodeId);
                    registry.byId('visitEditPaneTabContainer')
                        .addChild(visitAddTab);
                    visitAddTab.startup();
                },

                destroyPane: function (nodeId) {
                    if (this.initialized(this.nodeId)) {
                        registry.byId(this.nodeId)
                            .destroyRecursive();
                    }
                    this.constructor({
                        id: this.nodeId,
            ...
            editPane: {
                ...
                dijits: function (nodeId) {
                    var visitEditTab = new ContentPane({
                            id: nodeId,
                            closable: true
                        },
                        nodeId);
                    registry.byId('visitEditPaneTabContainer')
                        .addChild(visitEditTab);
                    visitEditTab.startup();
                },

                destroyPane: function (nodeId) {
                    if (this.initialized(nodeId)) {
                        registry.byId(nodeId)
                            .destroyRecursive();
                    }
            ...
            dijits: function () {
                ...
                if (!registry.byId('visitHomeContentPane')) {
                    console.log(
                        "No Visit pane dijits present, creating the same");
                    var centerTopTabPane = registry.byId('centerTopTabPane');
                    console.log(centerTopTabPane);

                    var visitHomeContentPane = new ContentPane({
                            id: 'visitHomeContentPane',
                            title: 'Visits',
                            closable: false
                        },
                    ...
                    //                         debugger
                    var visitPaneContentBorderContainer = new BorderContainer({
                            id: "visitPaneContentBorderContainer"
                        },
                        'visitPaneContentBorderContainer');
                    visitHomeContentPane.addChild(
                        visitPaneContentBorderContainer);
                    console.log(visitPaneContentBorderContainer);

                    var visitPaneTopbar = new ContentPane({
                            id: "visitPaneTopbar",
                            region: 'top',
                            splitter: false
                        },
                    ...
                    var visitPaneLSidebar = new ContentPane({
                            id: "visitPaneLSidebar",
                            region: 'leading',
                            splitter: true
                        },
                    ...
                    var visitLSidebarTabContainer = new TabContainer({
                            id: "visitLSidebarTabContainer",
                            tabStrip: true,
                            tabPosition: 'bottom',
                        },
                    ...
                    var visitLSidebarTreeContainer = new ContentPane({
                            id: "visitLSidebarTreeContainer",
                            title: "Tree",
                    ...
                    var visitPaneContentArea = new ContentPane({
                            id: "visitPaneContentArea",
                            region: 'center',
                            splitter: true,
                            gutters: true
                    ...
                    visitPaneContentBorderContainer.addChild(
                        visitPaneContentArea);
                    console.log(visitPaneContentArea);


                    var visitEditPaneTabContainer = new TabContainer({
                            id: 'visitEditPaneTabContainer',
                            tabStrip: true,
                            tabPosition: 'top'
                        },
                    ...
                    var visitSummaryTab = new ContentPane({
                            id: 'visitSummaryTab',
                            title: "Synopsis",
                            closable: false,
                            tabPosition: 'top'
...
//                         visitEditPane.startup();
                    ...
                    console.log(
                        "Visit Pane dijits already present. No recreating");
                    return registry.byId('visitHomeContentPane');
                }
            }
