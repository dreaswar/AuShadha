      ...
      domConstruct.create('div',
        ...
        domConstruct.create('div',
          ...
          domConstruct.create('div',
            ...
            domStyle.set( dom.byId('patientSidebarContentPane'),{'minWidth':'275px','minHeight':"400px",'overflow':"auto"});
            domStyle.set( dom.byId('patientTreeContainer'),{'minWidth':'275px','minHeight':"400px",'overflow':"auto"});
            domStyle.set( dom.byId('patientTreeDiv'),{'minWidth':'275px','minHeight':"400px",'overflow':"auto"});
            domStyle.set( dom.byId('patientSidebarDiv_contact'),{'minWidth':'275px','minHeight':"400px",'overflow':"auto"});
            domStyle.set( dom.byId('patientSidebarDiv_media'),{'minWidth':'275px','minHeight':"400px",'overflow':"auto"});
...
//{% if perms.patient %}
    var addAllergyButton =  new Button({
                                      ...
                                      iconClass: "dijitIconNewTask",
                                      style    :"position:relative; top: -17.6em; left: 58em;",
                                      onClick: function(){
                                             require(
                                              ["dojo/_base/xhr", "dojo/_base/array"],
                                              function(xhr, array){
