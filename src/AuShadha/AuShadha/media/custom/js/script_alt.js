...
function(on, registry, keys, ComboBox, FilteringSelect, Button, Memory, domConstruct){
    on(document.body, "keyup", function (e) {
//        if( registry.byId('centerTopTabPane').get('selected'))
//         e.keyCode;
        console.log(keys)
        if(e.keyCode == keys.INSERT ){
          if (CHOSEN_PATIENT){
            if( registry.byId('patientHomeContentPane').get('selected')){
              ...
              domConstruct.create("div", {id: "addChoiceFilteringSelect"},"addDialogForm","first");
              domConstruct.create("input", {id: "addChoiceSubmitButton",type:'submit', value: 'Go>'},"addDialogForm",1);
            ...
            */
             ...
             registry.byId("addDialog").set('content',filteringSelect);
//              registry.byId("addDialog").set('content',submitButton);
