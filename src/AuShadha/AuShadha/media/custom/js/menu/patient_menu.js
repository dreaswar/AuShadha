            ...
            pAddMenu.addChild(new MenuItem({
                ...
                onClick: function () {
                    require(["dojo/dom-construct",
                        ...
                        function (domConstruct, domStyle, ContentPane,
                            registry, dom) {
                            var urlDict = {
                                "neontalAndPaediatricExamUrl": CHOSEN_PATIENT
                                    .neonatalandpaediatricexamurl
                            }
                            if (!registry.byId(
                                'patientNeonatalAndPaediatricExamTab'
                            )) {
                                console.log(CHOSEN_PATIENT);
                                makeNeonatalAndPaediatricExamTab(
                                    urlDict);
                            } else {
                ...
                onClick: function () {
                    require(
                        ...
                        function (domConstruct,
                            ...
                            dom) {
                            var urlDict = {
                                "obstetricHistoryUrl": CHOSEN_PATIENT.obstetrichistorydetailadd
                            }
                            if (!registry.byId(
                ...
                onClick: function () {
                    require(["dojo/dom-construct",
                        ...
                        function (domConstruct, domStyle, ContentPane,
                            registry, dom) {
                            var urlDict = {
                                "gynaecologyHistoryUrl": CHOSEN_PATIENT
                                    .gynaecologyhistorydetailadd
                            }
                            if (!registry.byId(
                ...
                onClick: function () {
                    require(["dojo/dom-construct",
                        ...
                        function (domConstruct, domStyle, ContentPane,
                            registry, dom) {
                            var urlDict = {
                                "medicalPreventivesUrl": CHOSEN_PATIENT
                                    .medicalpreventivesadd
                            }
                            if (!registry.byId(
                ...
                onClick: function () {
                    require(["dojo/dom-construct",
                        ...
                        function (domConstruct, domStyle, ContentPane,
                            registry, dom) {
                            var urlDict = {
                                "surgicalPreventivesUrl": CHOSEN_PATIENT
                                    .surgicalpreventivesadd
                            }
                            if (!registry.byId(
