...
from .models import *
from dijit_widgets.tree import notesTree
...
@login_required
def notes_detail_list(request, id = None):
  pass

@login_required
def notes_detail_add(request,id = None):
  pass

@login_required
def notes_detail_edit(request, id):
  pass

@login_required
def notes_detail_del(request, id):
  pass

def return_notes_json( instance ,success = True):
   json_obj = ModelInstanceJson(instance)
   return json_obj()

@login_required
def render_notes_tree(request,id = None):
  pass

@login_required
def render_notes_summary(request, id=None):
  pass

@login_required
def render_notes_json(request, id = None):
  pass