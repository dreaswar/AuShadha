    ...
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            ...
            try:
                ...
                obs_and_gyn_history_obj = ObstetricHistoryDetail.objects.filter(
            ...
            obs_and_gyn_detail_obj = ObstetricHistoryDetail(
                patient_detail=patient_detail_obj)
            obs_and_gyn_detail_form = ObstetricHistoryDetailForm(
                request.POST, instance=obs_and_gyn_detail_obj)
...
def obstetric_history_detail_edit(request, id):
    if request.user:
        ...
        if request.method == "GET" and request.is_ajax():
            try:
                id = int(id)
                obs_and_gyn_detail_obj = ObstetricHistoryDetail.objects.get(
                    pk=id)
                obs_and_gyn_detail_form = ObstetricHistoryDetailForm(
                    instance=obs_and_gyn_detail_obj)
