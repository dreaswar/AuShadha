...
class ObstetricHistoryDetail(AuShadhaBaseModel):
  ...
  never_been_pregnant    = models.BooleanField('Click here if you have never been pregnant', default = False)
  adoped_children        = models.BooleanField(default = False)
  adoped_children_names  = models.TextField(default="Not Applicable", blank = True, null = True)
  pregnancy_listing      = models.TextField(
                                          default='''List all pregnancies in order, 
                                                     including still, premature births, 
                                                     ectopics and abortions
                                                   ''', 
