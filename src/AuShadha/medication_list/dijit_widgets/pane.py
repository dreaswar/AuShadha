...
from medication_list import MODULE_LABEL
from patient.models import PatientDetail


@login_required
def render_medication_list_pane(request, patient_id = None):
  ...
  if request.method == 'GET' and request.is_ajax():
    ...
    try:
      ...
      try:
        pane_template = Template( open('medication_list/dijit_widgets/pane.yaml','r').read() )
