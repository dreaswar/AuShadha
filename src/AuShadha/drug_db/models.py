...
class FDADrugs(models.Model):
  ...
  drug_name         = models.CharField('Drug Name', max_length =100,  null = True,  blank = True)
  dosage            = models.CharField('Dosage', max_length =100,  null = True,  blank = True)
  form              = models.CharField('Form', max_length =100,  null = True,  blank = True)
  active_ingredient = models.CharField('Active Ingredient', max_length =100,  null = True,  blank = True)
