    ...
    #addData = None
        ...
        #except PatientDetail.DoesNotExist:
            ...
            #medical_history_add_form = MedicalHistoryForm(
                ...
                #urls = medical_history_obj.urls

                #addData = {
                    #"id": medical_history_obj.id,
                    #"disease": medical_history_obj.disease,
                    #"icd_10_code": medical_history_obj.icd_10,
                    ...
                    #"date_of_diagnosis": medical_history_obj.date_of_diagnosis.date().isoformat(),
                    #"healed": medical_history_obj.healed,
                    #"remarks": medical_history_obj.remarks,
                    #"edit": medical_history_obj.urls['edit'],
                    #"del": medical_history_obj.urls['del']
                #}
                #error_message = "Medical History Saved Successfully"
                #form_errors = False

            #else:
                #success = False
                #error_message = aumodelformerrorformatter_factory(medical_history_add_form)
                #form_errors = True
                #addData = None
