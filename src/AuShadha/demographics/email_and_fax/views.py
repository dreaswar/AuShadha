...
def email_and_fax_json(request, patient_id=None):
    try:
        ...
        email_and_fax_obj = EmailAndFax.objects.filter(
            patient_detail=patient_detail_obj)
        jsondata = generate_json_for_datagrid(email_and_fax_obj)
    ...
    if request.user:
        ...
        try:
            ...
            if request.method == "GET" and request.is_ajax():
                email_and_fax_form = EmailAndFaxForm(
                    instance=email_and_fax_obj, auto_id=False)
